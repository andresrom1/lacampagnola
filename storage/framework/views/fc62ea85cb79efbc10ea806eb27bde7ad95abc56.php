...
<main class="page-home">
    <section class="search-section">
            ...
            <div class="form-content">
                <form action="<?php echo e(route('home-search')); ?>" method="POST">
                    ...
                    <div class="search-input">
                        <input type="search" name="q" id="recipe-query" autocomplete="off" placeholder="¿Qué receta estas buscando?" data-url="<?php echo e(route('recipe-predictive-search')); ?>">
                            ...
                            <li class="filtro">
                                ...
                                <div class="filtro-select-content">
                                    <select class="filtro-select select-popup" name="duration" data-selector="duration">
                                        ...
                                        <option value="<?php echo e($durationTag->id); ?>"><?php echo e($durationTag->title); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </li>
                            <li class="filtro">
                                ...
                                <div class="filtro-select-content">
                                    <select class="filtro-select select-popup" name="moment" data-selector="moment">
                                        ...
                                        <option value="<?php echo e($momentTag->id); ?>"><?php echo e($momentTag->title); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </li>
                            <li class="filtro">
                                ...
                                <div class="filtro-select-content">
                                    <select multiple class="filtro-select select-popup" name="special_needs[]" data-selector="special_needs">
                                        ...
                                        <option value="<?php echo e($specialNeedTag->id); ?>"><?php echo e($specialNeedTag->title); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </li>
        ...
        <div class="bk-slide">
            <ul class="bk-slide-content">
                <li class="item">
                    <img src="<?php echo e(asset('assets/images/home-main-bk.jpg')); ?>" srcset="<?php echo e(asset('assets/images/home-main-bk@2x.jpg')); ?> 2x" alt="home-main-bk" class="mobile">
                    <img src="<?php echo e(asset('assets/images/home-main-bk-d.jpg')); ?>" srcset="<?php echo e(asset('assets/images/home-main-bk-d@2x.jpg')); ?> 2x"  alt="home-main-bk" class="desktop">
                </li>
            </ul>
        </div>
    </section>
                ...
                <li class="swiper-slide item receta">
                    <a href="<?php echo e(route('recipe.details', $recipe->slug)); ?>">
                        ...
                        <ul class="caracteristicas">
                            ...
                            <li>
                                <?php if( !is_null($tagRecipe->icon_image) ): ?>
            ...
            <ul class="swiper-wrapper recetas-banner">
                ...
                <li class="swiper-slide item banner">
                    <div class="txt-content">
                        <div class="wrap">
                            <?php if( !is_null($banner->title) ): ?>
                            <div class="subtitle">
                                <h2><?php echo e($banner->title); ?></h2>
                            </div>
                            <?php endif; ?>
                            <?php if( !is_null($banner->text) ): ?>
                            <h3>
                                <?php if( !is_null($banner->link) ): ?>
                            ...
                            <?php endif; ?>
                            <?php if( $banner->tags()->count() > 0 ): ?>
                            <ul class="caracteristicas">
                                <?php $__currentLoopData = $banner->tags()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tagBanner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <?php if( !is_null($tagBanner->icon_image) ): ?>
                                    <span><img src="<?php echo e(asset($tagBanner->icon_image)); ?>" alt="<?php echo e($tagBanner->title); ?>"></span>
                                    <?php endif; ?>
                                    <p><?php echo e($tagBanner->title); ?></p>
                                </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                            <?php endif; ?>
                            <?php if( !is_null($banner->youtube_video) ): ?>
                                <?php
                                    $youtubeVideoJson = json_decode($banner->youtube_video);
                                ?>
                                <?php if( $agent->isMobile() || $agent->isTablet() ): ?>
                                <a href="<?php echo e($youtubeVideoJson->url); ?>" class="btn-ver-video" data-lity>ver video</a>
                                <?php endif; ?>
                                <?php if( $agent->isDesktop() && !is_null($banner->link) ): ?>
                                <a href="<?php echo e($banner->link); ?>" class="btn-ver-receta">ver receta</a>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
                    </div>
                    <?php if( !is_null($banner->mobile_image) || !is_null($banner->desktop_image) ): ?>
                    <div class="banner-bk">
                        <?php if( $agent->isDesktop() && isset($youtubeVideoJson) ): ?>
                        <a href="<?php echo e($youtubeVideoJson->url); ?>" class="btn-ver-video" data-lity>ver video</a>
                        <?php endif; ?>
                        <img src="<?php echo e($agent->isMobile() ? asset($banner->mobile_image) : asset($banner->desktop_image)); ?>" alt="<?php echo e($banner->title); ?>">
                    </div>
                    <?php endif; ?>
                </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php if( $productFamilies->count() > 0 ): ?>
