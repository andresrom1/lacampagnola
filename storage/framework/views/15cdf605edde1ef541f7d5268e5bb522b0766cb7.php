<?php $__env->startSection('title', '- Nuestra Historia'); ?>
<?php $__env->startSection('description', 'La Campagnola es una marca con más de 100 años acompañando la mesa familiar argentina. Referente en el mercado de los alimentos y reconocida por sus consumidores por la excelencia en la calidad y por su trayectoria.'); ?>
...
<main class="page-our-history">
    <section class="general-header">
        <div class="image-bk">
            <img src="<?php echo e(asset('assets/images/historia-home-header.jpg')); ?>" srcset="<?php echo e(asset('assets/images/historia-home-header@2x.jpg')); ?> 2x" alt="historia-home-header" class="mobile">
            <img src="<?php echo e(asset('assets/images/historia-home-header-d.jpg')); ?>" srcset="<?php echo e(asset('assets/images/historia-home-header-d@2x.jpg')); ?> 2x" alt="historia-home-header" class="desktop">
        </div>
    </section>
            ...
            <div class="wrap">
                ...
                <ul class="year-list">
                    ...
                    <li class="year">
                        <div class="img-content">
                            <!-- <div class="img"><img src="<?php echo e(asset('assets/images/history-1912.png')); ?>" alt="history-1912"></div> -->
                            <div class="img">
                                <img src="<?php echo e(asset('assets/images/history-1912.png')); ?>" srcset="<?php echo e(asset('assets/images/history-1912@2x.png')); ?> 2x" alt="history-1912">
                            </div>
                        </div>
                    ...
                    <li class="year">
                        <div class="img-content">
                            <div class="img">
                                <img src="<?php echo e(asset('assets/images/history-1933.png')); ?>" srcset="<?php echo e(asset('assets/images/history-1933@2x.png')); ?> 2x" alt="history-1933">
                            </div>
                        </div>
                    ...
                    <li class="year">
                        <div class="img-content">
                            <div class="img">
                                <img src="<?php echo e(asset('assets/images/history-1940.png')); ?>" srcset="<?php echo e(asset('assets/images/history-1940@2x.png')); ?> 2x" alt="history-1940">
                            </div>
                        </div>
                    ...
                    <li class="year">
                        <div class="img-content">
                            <div class="img">
                                <img src="<?php echo e(asset('assets/images/history-1950.png')); ?>" srcset="<?php echo e(asset('assets/images/history-1950@2x.png')); ?> 2x" alt="history-1950">
                            </div>
                        </div>
                    ...
                    <li class="year">
                        <div class="img-content">
                            <div class="img">
                                <img src="<?php echo e(asset('assets/images/history-1972.png')); ?>" srcset="<?php echo e(asset('assets/images/history-1972@2x.png')); ?> 2x" alt="history-1972">
                            </div>
                        </div>
                    ...
                    <li class="year">
                        <div class="img-content">
                            <div class="img">
                                <img src="<?php echo e(asset('assets/images/history-1980.png')); ?>" srcset="<?php echo e(asset('assets/images/history-1980@2x.png')); ?> 2x" alt="history-1980">
                            </div>
                        </div>
                    ...
                    <!-- <li class="year">
                        <div class="img-content">
                            <div class="img">
                                <img src="<?php echo e(asset('assets/images/history-1995.png')); ?>" srcset="<?php echo e(asset('assets/images/history-1995@2x.png')); ?> 2x" alt="history-1995">
                            </div>
                        </div>
                    ...
                    <li class="year">
                        <div class="img-content">
                            <div class="img">                            
                                <img src="<?php echo e(asset('assets/images/history-2012.png')); ?>" srcset="<?php echo e(asset('assets/images/history-2012@2x.png')); ?> 2x" alt="history-2012">
                            </div>
                        </div>
                    ...
                    <li class="year">
                        <div class="img-content">
                            <div class="img">                           
                                <img src="<?php echo e(asset('assets/images/history-2019.png')); ?>" srcset="<?php echo e(asset('assets/images/history-2019@2x.png')); ?> 2x" alt="history-2019">
                            </div>
                        </div>
			    ...
			    <p>Para convertir la comida de todos los días en platos extraordinarios, y que sepas que vas a encontrar en La Campagnola el aroma y sabor único de una marca con más de 100 años de historia.</p>
                    ...
                    <li class="year">
                        <div class="img-content">
                            <div class="img">                           
                                <img src="<?php echo e(asset('assets/images/history-2020.png')); ?>" srcset="<?php echo e(asset('assets/images/history-2020.png')); ?> 2x" alt="history-2020">
                            </div>
                        </div>
                    ...
                    <li class="year">
                        <div class="img-content">
                            <div class="img">                           
                                <img src="<?php echo e(asset('assets/images/history-2021.png')); ?>" srcset="<?php echo e(asset('assets/images/history-2021.png')); ?> 2x" alt="history-2021">
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/our-history.blade.php ENDPATH**/ ?>