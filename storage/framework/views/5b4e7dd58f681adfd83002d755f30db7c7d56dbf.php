<footer>
    <div class="footer-banner">
        <div class="wrap">
            <div class="txt-content">
                <h3>SEGUINOS <br>EN NUESTRAS REDES:</h3>
                <ul class="social">
                    <li class="icon fb">
        ...
        <div class="banner-bk">
            <img src="<?php echo e(asset('assets/images/footer-banner-bk.jpg')); ?>" srcset="<?php echo e(asset('assets/images/footer-banner-bk@2x.jpg')); ?> 2x" alt="footer-banner-bk" class="mobile">
        </div>
    </div>
    ...
    <div class="footer-legals">
        <div class="wrap">
            ...
            <div class="logo"><a href="<?php echo e(route('home')); ?>"></a></div>
            <div class="copy"><p>Todos los derechos reservados</p></div>
            <div class="terminos"><p><a href="<?php echo e(asset('assets/TerminosYCondiciones.pdf')); ?>" target="_blank" download>Términos y condiciones</a></p></div>
        </div>
    </div>
