<footer>
    <div class="footer-banner">
        ...
        <div class="banner-bk">
            <img src="{{ asset('assets/images/footer-banner-bk.jpg') }}" srcset="{{ asset('assets/images/footer-banner-bk@2x.jpg') }} 2x" alt="footer-banner-bk" class="mobile">
        </div>
    </div>
    ...
    <div class="footer-legals">
        <div class="wrap">
            ...
            <div class="terminos"><p><a href="{{ asset('assets/TerminosYCondiciones.pdf') }}" target="_blank" download>Términos y condiciones</a></p></div>
        </div>
    </div>
