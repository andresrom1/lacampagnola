        ...
        <div class="main-menu">
            ...
            <nav class="main-menu-content">
                <ul class="link-content">
                    <li class="link-btn"><a href="{{ route('our-history') }}">Nuestra Historia</a></li>
                    <span class="separator lightgrey"></span>
                    <li class="link-btn"><a href="{{ route('products') }}">Productos</a></li>
                    <span class="separator lightgrey"></span>
                    <li class="link-btn"><a href="{{ route('recipes') }}">Recetas</a></li>
                    <span class="separator lightgrey"></span>
                    <li class="link-btn"><a href="{{ route('vegetables') }}">#sumavegetales</a></li>
                    <span class="separator lightgrey"></span>
                    <li class="link-btn"><a href="{{ route('contact') }}">Contacto</a></li>
                    <span class="separator lightgrey"></span>
                </ul>
                ...
                <div class="copy"><p>Copyright La Campagnola {{ date('Y') }}.<br>Todos los derechos reservados.</p></div>
            </nav>
        </div>
        @if( Request::is('/') )
        <h1 class="logo"><a href="{{ route('home') }}"></a></h1>
        @else
        <h3 class="logo"><a href="{{ route('home') }}"></a></h3>
        @endif
        <div class="main-search">
            <div class="input-content"><input type="text" id="q" data-url="{{ route('predictive-search') }}" autocomplete="off"></div>
