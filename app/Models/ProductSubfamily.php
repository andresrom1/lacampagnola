...
class ProductSubfamily extends Model
{
    ...
    */
    ...
    protected $table = 'product_subfamilies';
    // protected $primaryKey = 'id';
    // public $timestamps = false;
    // protected $guarded = ['id'];
    protected $fillable = ['product_family_id','title','desktop_header_video','mobile_header_video','desktop_header_image','mobile_header_image','meta_title','meta_description','meta_keywords'];
    // protected $hidden = [];
    // protected $dates = [];
    ...
    */
    ...
    {
        return $this->belongsToMany('App\Models\Benefit', 'product_subfamily_benefit', 'product_subfamily_id', 'benefit_id');
    }
    ...
    */
    ...
    public function setDesktopHeaderImageAttribute($value)
    {
        ...
        $destination_path = "public/uploads/product_subfamilies"; // path relative to the disk above
